...
#define BARGRAPH_STYLE_2   0
#define BARGRAPH_STYLE_3   0
#define BARGRAPH_STYLE_4   0
#define BARGRAPH_STYLE_5   0
...
const unsigned char __attribute__ ((progmem)) LcdCustomChar[] =
{
	...
	0x1e, 0x1e, 0x1e, 0x1E, 0x1E, 0x1e, 0x1e, 0x00, // 4. 4/5 full progress block
